...
namespace CustomListTest
{
    ...
    public class UnitTests
    {
        ...
        [TestMethod]
        public void CustomList_Subtract_SubtractingOneValueCount()
        {
            //arrange
            CustomList<int> list1 = new CustomList<int>();
            int expected = 0;
        ...
        [TestMethod]
        public void CustomList_Subtract_SubtractingFiveValueArrayResize()
        {
            //arrange
            CustomList<int> list1 = new CustomList<int>();
            int expected = 5;
        ...
        [TestMethod]
        public void CustomList_Subtract_AddingOneStringIndicesCheck()
        {
            //arrange
            CustomList<string> list1 = new CustomList<string>();
            string expected = "string1";
